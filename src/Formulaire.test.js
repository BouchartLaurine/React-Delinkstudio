...
describe('Page Formulaire', () => {
  ...
  test('permet de remplir les champs et soumettre le formulaire', () => {
    ...
    fireEvent.change(screen.getByLabelText(/Date souhaitée/i), { target: { value: '2025-07-10' } });
    fireEvent.change(screen.getByLabelText(/Heure souhaitée/i), { target: { value: '14:00' } });
    fireEvent.change(screen.getByLabelText(/Type de tatouage/i), { target: { value: 'portrait' } });
